...
const ButtonDialogUpdate = ({
  ...
  const getPlainPasswordPromise = () => {
    return Axios.post(
      "/websitepasswords/get-decrypted-password/",
      {
  ...
  return (
    <div>
      ...
      >
        ...
        <DialogContent>
          <DialogContentText>
            To update the details for this website and show the password, please
...
const ButtonDialogShow = ({
  ...
  const handleClickOpenShow = () => {
    if (!isPasswordPlain && !isPasswordChanged) setOpenShow(true);
  };
  ...
  return (
    <div>
      ...
      >
        ...
        <DialogContent>
          <DialogContentText>
            To show the password for this website, please enter your master
            password here.
          </DialogContentText>
          <TextField
            autoFocus
